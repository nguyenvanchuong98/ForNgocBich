...
{
    public abstract class AspboilerTrainingWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static AspboilerTrainingWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(AspboilerTrainingWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<AspboilerTrainingDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<AspboilerTrainingDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<AspboilerTrainingDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<AspboilerTrainingDbContext, Task<T>> func)
        {
            T result;
