...
@Injectable()
export class QuanHuyenServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
    ...
    /**
     * @param tenhuyen (optional) 
     * @return Success
     */
    getAll(tenhuyen: string | null | undefined): Observable<QuanHuyenDtoPagedResultDto> {
        let url_ = this.baseUrl + "/api/services/app/QuanHuyen/GetAll?";
        if (tenhuyen !== undefined && tenhuyen !== null)
            url_ += "tenhuyen=" + encodeURIComponent("" + tenhuyen) + "&";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<QuanHuyenDtoPagedResultDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<QuanHuyenDtoPagedResultDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<QuanHuyenDtoPagedResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = QuanHuyenDtoPagedResultDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<QuanHuyenDtoPagedResultDto>(<any>null);
    }
}
...
export class TinhThanhServiceProxy {
     ...
     * @return Success
     */
    getAll(tentinh: string | null | undefined): Observable<TinhThanhDtoPagedResultDto> {
        let url_ = this.baseUrl + "/api/services/app/TinhThanh/GetAll?";
        if (tentinh !== undefined && tentinh !== null)
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<TinhThanhDtoPagedResultDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<TinhThanhDtoPagedResultDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<TinhThanhDtoPagedResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = TinhThanhDtoPagedResultDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<TinhThanhDtoPagedResultDto>(<any>null);
    }
}
...
export class QuanHuyenDto implements IQuanHuyenDto {
    ...
    constructor(data?: IQuanHuyenDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): QuanHuyenDto {
        data = typeof data === 'object' ? data : {};
        let result = new QuanHuyenDto();
        result.init(data);
        return result;
    }
...
export interface IQuanHuyenDto {
    mahuyen: string | undefined;
    tenhuyen: string | undefined;
    ghichu: string | undefined;
    matinh: string | undefined;
...
export class QuanHuyenDtoPagedResultDto implements IQuanHuyenDtoPagedResultDto {
    totalCount: number;
    items: QuanHuyenDto[] | undefined;

    constructor(data?: IQuanHuyenDtoPagedResultDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
        ...
        if (_data) {
            ...
            if (Array.isArray(_data["items"])) {
                ...
                for (let item of _data["items"])
                    this.items.push(QuanHuyenDto.fromJS(item));
            }
        }
    }

    static fromJS(data: any): QuanHuyenDtoPagedResultDto {
        data = typeof data === 'object' ? data : {};
        let result = new QuanHuyenDtoPagedResultDto();
        result.init(data);
        return result;
    }
    ...
    clone(): QuanHuyenDtoPagedResultDto {
        const json = this.toJSON();
        let result = new QuanHuyenDtoPagedResultDto();
        result.init(json);
        return result;
...
export interface IQuanHuyenDtoPagedResultDto {
    totalCount: number;
    items: QuanHuyenDto[] | undefined;
}
...
export class TinhThanhDtoPagedResultDto implements ITinhThanhDtoPagedResultDto {
    totalCount: number;
    items: TinhThanhDto[] | undefined;

    constructor(data?: ITinhThanhDtoPagedResultDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            if (Array.isArray(_data["items"])) {
                this.items = [] as any;
                for (let item of _data["items"])
                    this.items.push(TinhThanhDto.fromJS(item));
            }
        }
    }

    static fromJS(data: any): TinhThanhDtoPagedResultDto {
        data = typeof data === 'object' ? data : {};
        let result = new TinhThanhDtoPagedResultDto();
        result.init(data);
        return result;
    }
    ...
    clone(): TinhThanhDtoPagedResultDto {
        const json = this.toJSON();
        let result = new TinhThanhDtoPagedResultDto();
        result.init(json);
        return result;
